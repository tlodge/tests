...
var store = storelib.get(); //import { render } from 'react-dom';
...
function run() {
	...
	ReactDOM.render(React.createElement(_node2.default, props), document.getElementById('node'));
